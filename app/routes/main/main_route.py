...
@main.route('/about_us')
def about_us():
    logger.info('Se muestra información sobre nosotros')
...
def contact():
    ...
    if request.method == 'POST':
        ...
        logger.info('Se muestran contactos')
...
def get_products():
    ...
    logger.info('Se muestra la parte de productos')
...
def product_detail(product_id):
    ...
    logger.info('Se muestran detalles de productos')
...
def action_product_to_cart(product_id, action):
    ...
    logger.info('Se modifica el carrito de productos')
...
def remove_product_from_cart(product_id):
    ...
    logger.info('Se elimina del carrito de productos')
    return redirect(url_for('main.cart_resume'))
...
def cart_resume():
    ...
    logger.info('Se muestra el carro de productos')
...
def my_orders():
    ...
    logger.info('Se muestran las ordenes')
...
def success_screen():
    logger.info('Se muestra pantalla de pago exitoso')
    return render_template('status/payment/success.html')


@main.route('/payment/failure')
def failure_screen():
    logger.info('Se muestra pantalla de fallo en el pago')
